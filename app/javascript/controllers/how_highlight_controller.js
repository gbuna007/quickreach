  ...
  update(e) {
    ...
    switch(id) {
      case "1":
        ...
        this.imageTarget.innerHTML = "<img width='275' height='225' class='highlight-image-how' src='http://res.cloudinary.com/twx-a/image/upload/c_fill,h_225,w_275/int_how.png'>"
        break;
      case "2":
        ...
        e.currentTarget.classList.add("active")
        this.imageTarget.innerHTML = "<img width='275' height='225' class='highlight-image-how' src='http://res.cloudinary.com/twx-a/image/upload/c_fill,h_225,w_275/template_how.png'>"
        break;
      case "3":
      ...
      case "4":
        ...
        e.currentTarget.classList.add("active");
        this.imageTarget.innerHTML = "<img width='275' height='225' class='highlight-image-how' src='http://res.cloudinary.com/twx-a/image/upload/c_fill,h_225,w_275/read_how.png'>";
        break;
    }
  }
}
