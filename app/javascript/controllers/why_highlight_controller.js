  ...
  update(e) {
    ...
    switch(id) {
      case "1":
        ...
        this.imageTarget.innerHTML = "<img width='275' height='225' class='highlight-image-why' src='http://res.cloudinary.com/twx-a/image/upload/c_fill,h_225,w_275/integrate_crm.png'>"
        break;
      case "2":
        ...
        e.currentTarget.classList.add("active")
        this.imageTarget.innerHTML = "<img width='275' height='225' class='highlight-image-why' src='http://res.cloudinary.com/twx-a/image/upload/c_fill,h_225,w_275/automate_news.png'>"
        break;
      case "3":
        ...
        e.currentTarget.classList.add("active")
        this.imageTarget.innerHTML = "<img width='275' height='225' class='highlight-image-why' src='http://res.cloudinary.com/twx-a/image/upload/c_fill,h_225,w_275/newspaper.png'>"
        break;
      case "4":
        ...
        e.currentTarget.classList.add("active")
        this.imageTarget.innerHTML = "<img width='275' height='225' class='highlight-image-why' src='http://res.cloudinary.com/twx-a/image/upload/c_fill,h_225,w_275/email.png'>"
        break;
    }
  }
}
